...
def plot(band):
    ...
    plt.savefig("../figures/percent_errors_1Dhist_{}.eps".format(band))
    plt.savefig("../figures/percent_errors_1Dhist_{}.png".format(band))
    plt.savefig("../figures/percent_errors_1Dhist_{}.pdf".format(band))
    ...
    plt.savefig("../figures/failure_rate_{}.eps".format(band))
    plt.savefig("../figures/failure_rate_{}.pdf".format(band))
    plt.savefig("../figures/failure_rate_{}.png".format(band))
    plt.clf()
    plt.plot(x, s, 'x')
    plt.title("SNR {} results".format(band))
    plt.xlabel("SNR$_{known}")
    plt.ylabel("Success Rate (error<10%)")
    plt.savefig("../figures/success_rate_{}.eps".format(band))
    plt.savefig("../figures/success_rate_{}.pdf".format(band))
    plt.savefig("../figures/success_rate_{}.png".format(band))
